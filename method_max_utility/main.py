...
if __name__ == '__main__':
    ...
    para_arg.add_argument('--T_period', type=int, default=100)
    ...
    model_arg.add_argument("--output_dim", type=int, default = 1)
    ...
    model_arg.add_argument("--use_test_data", type=bool, default = True)

    model_arg.add_argument("--save_test_data_path", type=str, default = path+"\\data\\test_data.npy")
