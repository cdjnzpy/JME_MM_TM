...
if __name__ == '__main__':
    ...
    para_arg.add_argument('--T_period_test', type=int, default=200)
    ...
    model_arg.add_argument("--output_dim", type=int, default = 1+1+1)
    model_arg.add_argument("--hidden_layer", type=list, default = [8,8,8])
    model_arg.add_argument("--save_model_path", type=str, default = path+"\\save\\model\\Phi_h_V_Model_8X8.pt")
    model_arg.add_argument("--save_data_path", type=str, default = path+"\\save\\data_8X8.npy")
    ...
    #plot_different
    plot_different_model.plot_figure(args)
