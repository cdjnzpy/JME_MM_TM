...
class NN_net_phi_h_eval(nn.Module):
    def __init__(self, args, input_dim, hidden_layer, output_dim):
        super().__init__()
        self.args = args
        self.activation = nn.ReLU()

        self.Linear1 = nn.Linear(input_dim, hidden_layer[0])
        self.Linear2 = nn.Linear(hidden_layer[0], hidden_layer[1])
        self.Linear3 = nn.Linear(hidden_layer[1], hidden_layer[2])
        self.Linear_last = nn.Linear(hidden_layer[2],output_dim)
